...
if !exists("g:DoxygenToolkit_defgroupTag")
	let g:DoxygenToolkit_defgroupTag = " @defgroup "
endif
...
function! <SID>DoxygenCommentFunc()
	...
	exec "normal O" . g:DoxygenToolkit_startCommentTag . g:DoxygenToolkit_blockHeader
        " [Tsuna] Workaround to comply with EPITA coding style ... it's
        " probably ugly but at least it works :D
        set nocindent
	...
	if ( l:argList != 0 )
		exec "normal `d" . g:DoxygenToolkit_interCommentTag
	endif
...
""""""""""""""""""""""""""
function! <SID>DoxygenCommentHeader()
	" Save standard comment expension
	let l:oldComments = &comments
	let &comments = ""
	" Store indentation
	...
	if !exists("g:DoxygenToolkit_projectName")
                let g:DoxygenToolkit_projectName = input("Enter project name: ")
	endif
	let l:DoxygenToolkit_moduleName = input("Enter module name: ")
	...
	" Begin to write skeleton
        ...
        exec "normal 11G"
	exec "normal O" . g:DoxygenToolkit_startCommentTag
	exec "normal o" . g:DoxygenToolkit_interCommentTag . g:DoxygenToolkit_fileTag
	exec "normal o" . g:DoxygenToolkit_interCommentTag . g:DoxygenToolkit_briefTag_pre
	mark d
        exec "normal o" . g:DoxygenToolkit_interCommentTag . g:DoxygenToolkit_defgroupTag . l:DoxygenToolkit_moduleName . " "
        exec "normal o" . g:DoxygenToolkit_interCommentTag . g:DoxygenToolkit_ingroupTag . g:DoxygenToolkit_projectName
        exec "normal o" . "{@"
	if ( g:DoxygenToolkit_endCommentTag == "" )
		exec "normal o" . g:DoxygenToolkit_interCommentTag
	else
...
command! -nargs=0 DoxHeader :call <SID>DoxygenCommentHeader()
